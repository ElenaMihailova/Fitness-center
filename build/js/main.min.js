...
/* harmony import */ var _modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/validate/validate */ "./js/modules/validate/validate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["sliderCoaches"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["sliderFeedback"])();
    Object(_modules_video_video__WEBPACK_IMPORTED_MODULE_3__["video"])();
    Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_4__["tabs"])();
    Object(_modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__["validityForm"])(_modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__["inputPhoneContacts"], _modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__["inputNameContacts"]);
    Object(_modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__["sendUserFormData"])(_modules_validate_validate__WEBPACK_IMPORTED_MODULE_5__["contactsForm"]);
  });
});
...
var sliderCoaches = function sliderCoaches() {
  var swiperCoaches = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-coaches', {
...
var sliderFeedback = function sliderFeedback() {
  var swiperFeedback = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-feedback', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
    observer: true,
    slidesPerView: 1,
    slidesPerGroup: 1,
  ...
  tabControls.forEach(function (control) {
    control.addEventListener('click', function (evt) {
      ...
      for (var _i = 0; _i < tabContent.length; _i++) {
        if (tabContent[_i].classList.contains('membership__sublist--active')) {
          tabContent[_i].classList.remove('membership__sublist--active');
          break;
        }
      }
...
var contactsSection = document.querySelector('.lesson');
...
var validityForm = function validityForm(phone, name) {
  phone.addEventListener('input', function (evt) {
    var lengthInputPhone = phone.value.length;
    if (!validityInputNumber.test(phone.value)) {
      ...
      onInputValueError(evt);
      phone.setCustomValidity("\u0415\u0449\u0435 \u043D\u0443\u0436\u043D\u043E \u0432\u0432\u0435\u0441\u0442\u0438 \u043C\u0438\u043D\u0438\u043C\u0443\u043C ".concat(MIN_LENGTH_PHONE - lengthInputPhone, " \u0446\u0438\u0444\u0440"));
    } else if (lengthInputPhone > MAX_LENGTH_PHONE) {
      onInputValueError(evt);
      phone.setCustomValidity("\u041D\u0443\u0436\u043D\u043E \u0443\u0434\u0430\u043B\u0438\u0442\u044C ".concat(lengthInputPhone - MAX_LENGTH_PHONE, " \u0446\u0438\u0444\u0440"));
    } else {
